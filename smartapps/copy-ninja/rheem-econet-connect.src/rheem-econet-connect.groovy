...
def setDeviceSetPoint(childDevice, deviceData = []) { 
	...
	if (login()) { apiPost("/v3/eco/myequipmentattributes/savewhtemp", [body: [ TempDisplayMode: deviceData.temperatureUnit, EquipmentId: getDeviceID(childDevice), SetPoint: deviceData.setPoint ]] ) }
}
